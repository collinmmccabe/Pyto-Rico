Class Market
Class Buildings
Attr available_buildings (dict)
{'small indigo plant’: 3, 'small sugar plant’: 3, …}
Method building_bought(building)
If available_buildings[building] > 0, available_buildings[building] -= 1
Class Plantations
Attr face_down_pool (list)
e.g. [‘corn’, ‘corn’, ‘sugar’, ‘coffee’, ‘coffee’, …]
Attr face_up_pool (list)
e.g. [‘indigo’, ‘corn’, ‘coffee’, ‘coffee’] for 3 players
